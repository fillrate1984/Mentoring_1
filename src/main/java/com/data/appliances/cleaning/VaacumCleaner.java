package com.data.appliances.cleaning;
...
public class VaacumCleaner extends Appliance {
    public VaacumCleaner(String name, int power, Locations location, Affliation cleaning) {
